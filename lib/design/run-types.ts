...
// renderComposed()'s default per-render deadline (lock wait included). Lives
// here, not in the renderer, so callers budgeting time never import Chromium.
export const RENDER_DEADLINE_MS = 45_000
