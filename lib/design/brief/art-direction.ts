...
- Signature CSS: every concept includes 2–3 scoped css.blocks moves — e.g. the hero, one card family (service-cards, feature-grid or content-cards), the section headings of a content block — and each one implements a named entry in moves[] (name its block in that move). Tokens and treatments alone read as a recolor. Keep every fragment within the CSS limits in the contract.
