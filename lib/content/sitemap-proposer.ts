...
- HIGH-INTENT INTERSECTIONS: where a specific niche has a distinct, substantial need for a specific service (e.g. a service a niche buys differently than everyone else), propose a niche×service page for that pairing (e.g. "/industries/<niche>/<service>" or a "<service> for <niche>" page nested under the niche). Only for pairings with real differentiated demand — do NOT enumerate every niche×service combination, and never create a thin/duplicate page. A handful of the strongest pairings at most.
