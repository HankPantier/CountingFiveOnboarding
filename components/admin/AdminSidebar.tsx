...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    label: 'Admin',
    items: [
      { href: '/admin/content-quality', label: 'Content quality', d: 'M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0zM12 12l4-3M9 15l2-2', requires: 'admin' },
      ...
      { href: '/admin/no-go-phrases', label: 'No-go phrases', d: 'M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18zM5.6 5.6l12.8 12.8', requires: 'admin' },
    ],
  },
]
